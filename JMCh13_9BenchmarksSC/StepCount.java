/**
 * Class to aid in the tracking of steps in implemented sort methods. An
 * instrumented sort method must be provided.
 * 
 * @author George Peck
 * @version Nov 15, 2014
 * @author Period: 1-7
...
public abstract class StepCount
{
     ...
     * 
     * @param countToAdd
     *            counts to add to the step counter
     */

...
public class Benchmarks extends JFrame
{
     ...
     * specified in sortMethod: 1 -- Bubble Sort 2 -- Selection Sort 3 --
     * Insertion Sort 4 -- Mergesort 5 -- Quicksort Returns the total number of
     * steps it took.
     * 
     * @param a
     *            array of doubles to be filled with random numbers
     * @param sm
     *            array of possible sort methods
     * @param sortMethod
     *            index of method to used for sort

...
public class StockExchange
{
    ...
    {
        Stock a = new Stock( symbol, name, price );
        listedStocks.put( symbol, a );
    }
    ...
    {
        String symb = order.getSymbol();
        Stock s = listedStocks.get( symb );
        if ( s == null )
        {
            Trader ret = order.getTrader();
            ret.receiveMessage( symb + " not found" );
            return;
        }
        s.placeOrder( order );
    }

...
public class TextCell extends Actor
{
    ...
    /**
     * Constructs a white TextCell.
     * @param str text to display in cell
     */
     ...
     * @param cellColor the background color of this cell
     */
    ...
    /**
     * Constructs a white TextCell.
     * @param numVal number to display as text in cell
     */
     ...
     * @param number to display as text in cell
     * @param cellColor the background color of this cell
     */
